...
<body>
  <div class="container-scroller">
    ...
    @include('components.sub-components.top-nav-bar', array('pageTitle' => 'Dashboard'))

    <div class="container-fluid page-body-wrapper">

      @include('components.sub-components.theme-wrapper')

      @include('components.sub-components.left-nav-link')
